...
<div class="card" style="max-width:44rem;margin:0 auto;line-height:1.7">
    ...
    <p>
        Je soussigne(e), responsable de l'établissement <strong><?= $this->e($tenantName) ?></strong>,
        certifie que :
    </p>
    ...
    <p>
        est regulierement inscrit(e) dans notre établissement en classe de
        <strong><?= $this->e($enrollment['classroom_name']) ?></strong>
        au titre de l'année académique <strong><?= $this->e($enrollment['year_label']) ?></strong>.
    </p>
    ...
    <div style="display:flex;justify-content:space-between;margin-top:3rem">
        ...
        <div style="text-align:center">
            <div class="muted" style="margin-bottom:2.5rem">Le chef d'établissement</div>
