...
return [
     ...
     */
    'names' => [
        'structure.cycles' => 'Cycles et niveaux',
        'structure.programs' => 'Filieres et programmes',
        'structure.classrooms' => 'Classes',
        'structure.rooms' => 'Salles',
        'subjects.list' => 'Matieres enseignees',
        'subjects.teaching_units' => 'Unites d enseignement',
        'subjects.categories' => 'Categories de matieres',
        'evaluation.competencies' => 'Evaluation par competences',
        'periods.sequences' => 'Sequences',
        'exams.cep' => 'CEP (Certificat d etudes primaires)',
        'exams.bepc' => 'BEPC',
        'exams.probatoire' => 'Probatoire',
        'exams.baccalaureat' => 'Baccalaureat',
        'exams.cap_bep' => 'CAP et BEP',
        'exams.oral_resit' => 'Rattrapage a l oral',
        'exams.series' => 'Series d examen',
        'bulletins.sequential' => 'Bulletin de sequence',
        'bulletins.semester_transcript' => 'Releve de notes semestriel',
        'bulletins.attestation' => 'Attestation de scolarite',
        'bulletins.certificate' => 'Certificat de scolarite',
        'bulletins.school_card' => 'Carte scolaire',
        'bulletins.class_council' => 'Conseil de classe',
        'enrollment.public_preregistration' => 'Pre-inscription en ligne',
        'enrollment.series_field' => 'Choix de la serie a l inscription',
        'enrollment.repeater' => 'Suivi des redoublants',
        'enrollment.import' => 'Import des eleves',
        'enrollment.internships' => 'Stages en entreprise',
        'life.timetable' => 'Emploi du temps',
        'life.attendance' => 'Presences et absences',
        'finance.fees' => 'Frais de scolarite',
        'finance.payments' => 'Encaissement des paiements',
        'hr.cnps_dipe' => 'Declarations CNPS / DIPE',
        'report.dashboard' => 'Tableau de bord statistique',
        'report.by_level' => 'Statistiques par niveau',
        'report.by_series' => 'Statistiques par serie',
        'report.by_program' => 'Statistiques par filiere',
        'report.minedub' => 'Rapports MINEDUB',
        'report.minesec' => 'Rapports MINESEC',
        'report.minesup' => 'Rapports MINESUP',
        'report.export' => 'Export des donnees',
