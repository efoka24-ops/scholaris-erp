...
export class TenantsService {
  ...
  async updateConfig(id: string, config: unknown): Promise<CalculationEngineConfig> {
    ...
    // Fusionner avec le config_json existant pour préserver enabledModules
  ...
  /**
   * Modules/fonctionnalités activés pour cet établissement.
   * Stockés sous une clé dédiée de Tenant.config_json.
   */
