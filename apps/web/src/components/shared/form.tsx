...
// Wrapper Shadcn-style autour de react-hook-form : c'est le "FormBuilder" du guide
// (§0.A) — chaque module compose ses champs avec <FormField>/<FormItem> plutôt que
// de reconstruire la plomberie de validation à chaque écran.
